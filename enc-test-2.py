...
#enc.encrypt_file("C:/Users/rapidslayer101/Downloads/muted.quicktime", alpha1, alpha2, num2, seed3, "muted.renc")
enc.encrypt_file("user_agents.zip", alpha1, alpha2, num2, seed3, "muted.renc")
...
print(enc.decrypt_file("muted.renc", alpha1, alpha2, num2, seed3, "file.dec"))
